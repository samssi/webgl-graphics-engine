...
import {colorUniformLocation, modelViewProjection, vertexObjectCoordinates} from "./shaderSourceSingleColor";
...
export const draw3DEntitiesSingleColor = (entities: Entity3d[], program: WebGLProgram): void => {
    if (entities) {
